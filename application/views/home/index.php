                            ...
                            <div class="col-xl-3 col-md-12">
                                <div class="card proj-t-card">
                                    <div class="card-body text-navy">
                                        ...
                                        <h6 class="pt-badge bg-navy small">Stop Car</h6>
                                    </div>
                                </div>
                            </div>
                           <!-- mensalidades-->
            ...
            <!-- Fim vagas e categorias da home -->
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        ...
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Desenvolvido <i class="fas fa-code text-dark"></i><a href="" class="text-dark" target="_blank">Paulo Roberto</a></span>
                    </div>
                </footer>
